  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-800/80 bg-[#04070d]/92 backdrop-blur-xl">
      ...
      >
        ...
        <div className="hidden items-center gap-4 text-[13px] font-medium text-slate-300 xl:flex">
          {navItems.map((item) => (
          ...
          <Link
            href="/contact"
            className="ml-1 rounded-full border border-cyan-300/40 px-4 py-2 text-xs font-semibold text-cyan-100 transition hover:border-cyan-200 hover:text-white"
          >
            Contact
          </Link>
        </div>
