...
5. **Interactive operating-system explainer**
   - Build and approve the animation/interactive experience.
   - Pass its approved URL to `SystemExplainer` in `app/operating-system/page.tsx`; the current static cycle is the no-server-change fallback.
